    ...
    <main>
        ...
        <section class="bg-white">
            <div class="container py-5">
                <h2 class="text-center">The strength of AADE is the positive, proactive and cooperation between it’s people. To understand the need of the ARTS to make a difference in the lives of the community we serve. We dance for peace, for health and the well-being of all.</h2>
            </div>
        </section>
        <section class="pink-section">
            <div class="container py-5">
                <h2 class="text-center"><q>In The Moment Of Crisis, The Wise Build Bridges And The Foolish Build Dams.
                </q></h2>
